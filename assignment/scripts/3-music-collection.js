...
console.log(
  "Added to collection:",
  addToCollection("Whatever and Ever Amen", "Ben Folds Five", "1997", [
    {
      trackNumber: 1,
...
console.log(
  "Added to collection:",
  addToCollection("Spelled In Bones", "Fruit Bats", "2005", [
    {
      trackNumber: 1,
...
console.log(
  "I have these albums by Bob Dylan in my collection:",
...
function search(artistYearObj) {
  ...
  if (artistYearObj && Object.keys(artistYearObj).length > 0) {
    ...
    for (const x of collection) {
      if (
        artistYearObj.artist === x.artist &&
        artistYearObj.year === x.yearPublished
      ) {
        results.push(x);
      } //end conditional
    } //end for of loop
...
console.log(
  "search for a bob dylan album from 1965:",
  search({ artist: "Bob Dylan", year: "1965" })
);
console.log(
  "search for a bob dylan album from 1964:",
  search({ artist: "Bob Dylan", year: "1964" })
);
console.log(
  "expect full original collection when passed no argument",
  search()
);
console.log(
  "expect full original collection when passed an empty object",
  search({})
);
...
console.log(
  `the song Kate is found in ${findByTrackName("Kate")[0][0].title} by ${
    findByTrackName("Kate")[0][0].artist
  }. It is track number ${findByTrackName("Kate")[0][1].trackNumber}`
...
function multiSearch(artist, year, trackName) {
  ...
  if (trackName) {
    //need a conditional to ignore this code if there's no input
...
console.log(
  "expect 2 albums from Bob Dylan:",
  multiSearch("Bob Dylan", "", "")
);
console.log(
  "expect 1 album from Bob Dylan from 1965:",
  multiSearch("Bob Dylan", "1965", "")
);
console.log(
  "expect 1 album from Bob Dylan that has the song Like a Rolling Stone:",
  multiSearch("", "", "Like a Rolling Stone")
);
